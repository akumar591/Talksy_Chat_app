...
const Profile = () => {
  ...
  const handleLogout = async () => {
    if (logoutRef.current || loggingOut) {
      return;
    }
          ...
          <div className="mt-4 w-full text-center">
            {editField === "name" ? (
              <div className="flex justify-center items-center gap-2">
                ...
                <button disabled={loading} onClick={() => saveField("name")}>
          ...
          <div className="mt-2 w-full text-center text-sm opacity-70">
            {editField === "about" ? (
              <div className="flex justify-center items-center gap-2">
                ...
                <button disabled={loading} onClick={() => saveField("about")}>
                  <FiCheck className="text-green-400 cursor-pointer" />
                </button>
              </div>
            ) : (
              <div className="flex justify-center items-center gap-2">
                <span>{user.about || "No bio"}</span>
          ...
          <div className="mt-2 w-full text-center text-sm opacity-80">
            {editField === "email" ? (
              <div className="flex justify-center items-center gap-2">
                ...
                <button disabled={loading} onClick={() => saveField("email")}>
                  <FiCheck className="text-green-400 cursor-pointer" />
                </button>
              </div>
            ) : (
